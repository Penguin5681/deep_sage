/// A utility class that provides access to application icon assets.
///
/// This class contains static constants for all icon paths used throughout the app,
/// organized by theme (light/dark mode) and icon type.
class AppIcons {
  /// Base path for light mode icon assets
  static const String lightModeBasePath = 'assets/icons/dark';

  /// Base path for dark mode icon assets
  static const String darkModeBasePath = 'assets/icons/light';

  /// Base path for brand icon assets
  static const String brandIconPath = 'assets/icons/brand';

  /// Chart icon for light mode
  static const String chartLight = '$lightModeBasePath/chart.png';

  /// Chart icon for dark mode
  ...
  /// Report icon for light mode
  static const String reportLight = '$lightModeBasePath/report.png';

  /// Report icon for dark mode
  ...
  /// Machine learning icon for dark mode
